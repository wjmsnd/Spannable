...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTv4() {
        ...
        ss.setSpan(new StrikethroughSpan(), 0, 3, Spannable.

                SPAN_INCLUSIVE_EXCLUSIVE);

        ss.setSpan(new SuperscriptSpan(),4,6,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);


        ss.setSpan(new SubscriptSpan(),7,9,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);


        maskFilterSpan = new MaskFilterSpan(new EmbossMaskFilter(new float[]{1,1,3}, 1.5f, 8, 3));

        ss.setSpan(maskFilterSpan,10,13,Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
